...
class AutoClick():
	...
	def get_winds(self, title: str):
		"""
		@description : 獲取遊戲句柄 ,並把遊戲窗口置頂並激活窗口
		---------
		@param : 窗口名
		-------
		@Returns : 窗口句柄
